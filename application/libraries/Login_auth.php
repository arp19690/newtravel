...
//            prd($record);
    ...
    public function logout($user_id = NULL, $redirect_to = NULL, $logout_message = NULL)
    {
        ...
        if ($user_id != NULL || !empty($user_id))
        {
            ...
            $record = $model->fetchSelectedData("ul_id", TABLE_USER_LOG, array("ul_user_id" => $user_id, "ul_logout_timestamp" => ""), "ul_id", "DESC", "0,1");
            $ul_id = $record[0]["ul_id"];

            $update_data_array = array();
            $update_data_array["ul_logout_timestamp"] = time();
